        ...
        <div class="box-body">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <asp:Button ID="btnDelete" runat="server" Style="float: right;" CssClass="btn btn-success" Text="批量删除" OnClick="btnDelete_Click" OnClientClick="javascript:return fn.DeleteConfirm();" Visible="false" />
                </div>
