<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error.aspx.cs" Inherits="CMBPayment.error" %>
        ...
        <section class="content">
            <div class="error-page">
                ...
                <div class="error-content">
                    <h3><i class="fa fa-warning text-yellow"></i>  System error occurs</h3>
                </div>
                <!-- /.error-content -->
            </div>
            <table style="width: 100%; height: 100%">
                <tr style="height: 50px">
                    <td>
                        <asp:Label ID="lblError" runat="server" CssClass="warningMSG"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
